...
\newcommand\programming{
	\raggedright{
	{C\# $\textbullet$ Angular 2/4+ $\textbullet$AngularJS $\textbullet$ TypeScript $\textbullet$ JavaScript $\textbullet$ Java $\textbullet$ Swift $\textbullet$ Objective-C $\textbullet$ Python $\textbullet$ VB.NET $\textbullet$ PHP $\textbullet$ C++ $\textbullet$ C $\textbullet$ SQL $\textbullet$ MATLAB $\textbullet$ Assembly $\textbullet$ NodeJS $\textbullet$ HTML5 $\textbullet$ LESS/SASS }}
}
...
\newcommand\interests {
{Traveling $\textbullet$ Hiking $\textbullet$ Cooking $\textbullet$ Baking $\textbullet$ Photography $\textbullet$ Aerial Photography }
}
